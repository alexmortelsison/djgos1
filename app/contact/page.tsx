      ...
      <div className="lg:flex justify-center overflow-hidden px-8 md:space-x-64">
        <div className="text-center justify-center mt-64 md:mt-82">
          ...
          <div className="flex flex-col justify-start mt-16 space-y-4">
            <div className="flex items-center space-x-4">
              ...
              <p className="text opacity-0">0917-000-0000</p>
            </div>
            <div className="flex items-center space-x-4">
              <a
                target="_blank"
                className="hover:cursor-pointer"
                href="https://www.instagram.com/in.gos.we.trust/"
              >
                <svg
                  className="icon opacity-0"
                  stroke="currentColor"
              ...
              <p className="text opacity-0">in.gos.we.trust</p>
            </div>
            <div className="flex items-center space-x-4">
              <a
                ...
                target="_blank"
                className="hover:cursor-pointer"
                href="https://mail.google.com/mail/?view=cm&fs=1&to=henrygosuico@gmail.com"
              >
                <svg
                  className="icon opacity-0"
                  stroke="currentColor"
              ...
              <p className="text opacity-0">henrygosuico@gmail.com</p>
            </div>
          </div>
        </div>
        <div className="mt-64 hidden lg:block">
          <Image
            ...
            height={2000}
            alt="gos"
            className="h-[500px] w-auto object-contain rounded-2xl opacity-0"
          />
        </div>
      </div>
    </div>
